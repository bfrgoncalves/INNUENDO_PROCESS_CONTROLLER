...
cat job_processing/sbatch_innuca_1.template | sed "s#$OLD#$1#1" > sbatch_innuca_1.sh
...
cat sbatch_innuca_1.sh | sed "s#$FILESTOTRANSFER#$2#1" > sbatch_innuca_2.sh
...
cat sbatch_innuca_2.sh | sed "s#$USER_D#$3#1" > sbatch_innuca.sh
